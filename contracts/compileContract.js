...
const content = fs.readFileSync('contracts/ChatContract.sol');
const input = {'ChatContract.sol': content.toString()};
...
const contractKey = 'ChatContract.sol:Chatnew';
...
fs.writeFileSync(abidir + 'TestAbi.js', 'export default ' + abiJson);